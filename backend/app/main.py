...
from app.api import leases, extractions, health, auth, organizations, teams, analytics, few_shot, prompts
...
app.include_router(few_shot.router, prefix="/api/few-shot", tags=["few-shot"])
